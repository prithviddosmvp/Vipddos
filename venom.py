...
TOKEN = '7382979464:AAE2A2biMpL4K35WlC8vr93mEBasYwlTpUg'
...
FORWARD_CHANNEL_ID = -1002189946010
CHANNEL_ID = -1002189946010
error_channel_id = -1002189946010
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/gythack/432*", parse_mode='Markdown')
